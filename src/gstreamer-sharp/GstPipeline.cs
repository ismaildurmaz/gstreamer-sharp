...
namespace Gst
{
    ...
    public class GstPipeline : GstBin
    {
        ...
        {
            get { return Utils.HandleObject<GstClock>(gst_pipeline_get_clock(Handle)); }
            set
            {
        ...
        {
            get { return gst_pipeline_get_auto_flush_bus(Handle); }
            set { gst_pipeline_set_auto_flush_bus(Handle, value); }
        }
