...
namespace Gst.Plugins.Base
{
    ...
    public class PlayBin2 : GstPipeline
    {
        ...
        /// <summary>
        ///     Set the next URI that playbin will play. This property can be set from the about-to-finish signal to queue the next
        ///     media file.
        /// </summary>
        public Uri Uri
        {
            get { return GetUri("uri"); }
            set { Set("uri", value); }
        }
        ...
        {
            get { return (GstPlayFlags) GetInt32("flags"); }
            set { Set("flags", (int) value); }
        }
        ...
        {
            get { return GetUInt32("connection-speed"); }
            set { Set("connection-speed", value); }
        }
        ...
        {
            get { return GetInt32("current-audio"); }
            set { Set("current-audio", value); }
        }
        ...
        {
            get { return GetInt32("current-text"); }
            set { Set("current-text", value); }
        }
        ...
        {
            get { return GetInt32("current-video"); }
            set { Set("current-video", value); }
        }

        /// <summary>
        ///     Encoding to assume if input subtitles are not in UTF-8 encoding. If not set, the GST_SUBTITLE_ENCODING environment
        ///     variable will be checked for an encoding to use. If that is not set either, ISO-8859-15 will be assumed.
        ///     Default value: null
        /// </summary>
        public string SubtitleEncoding
        {
            get { return GetString("subtitle-encoding"); }
            set { Set("subtitle-encoding", value); }
        }


        /// <summary>
        ///     Set the next subtitle URI that playbin will play. This property can be set from the about-to-finish signal to queue
        ///     the next subtitle media file.
        ///     Default value: null
        /// </summary>
        public Uri SubtitleUri
        {
            get { return GetUri("suburi"); }
            set { Set("suburi", value); }
        }
        ...
        {
            set { Set("subtitle-font-desc", value); }
        }
        ...
        {
            get { return GetStructure<GstElement>("video-sink"); }
            set { Set("video-sink", value); }
        }
        ...
        {
            get { return GetStructure<GstElement>("audio-sink"); }
            set { Set("audio-sink", value); }
        }
        ...
        {
            get { return GetStructure<GstElement>("text-sink"); }
            set { Set("text-sink", value); }
        }
        ...
        {
            get { return GetStructure<GstElement>("subpic-sink"); }
            set { Set("subpic-sink", value); }
        }
        ...
        {
            get { return GetStructure<GstElement>("vis-plugin"); }
            set { Set("vis-plugin", value); }
        }

        /// <summary>
        ///     Control the synchronisation offset between the audio and video streams. Positive values make the audio ahead of the
        ///     video and negative values make the audio go behind the video.
        ///     Since 0.10.30
        /// </summary>
        ...
        /// <summary>
        ///     Get the currently rendered or prerolled frame in the video sink. The GstCaps on the buffer will describe the format
        ///     of the buffer.
        /// </summary>
        ...
        {
            get { return GetStructure<GstElement>("source"); }
        }
    }
}